...
.component('settings', {
  ...
  template: `
    <h2 style="margin-left:25px;margin-top:40px;">Account settings</h2>
    ...
    <div ng-if="!loading" ng-controller="SettingsController" layout="column" ng-cloak style="max-width:600px;">
    
      <md-content layout-padding class="settingscontent">
        <form name="settingsForm">
          ...
          <md-card class="settingscard" md-colors="{background: 'blue-grey'}">
            ...
            <md-divider />
            <md-card-content>
              <md-tooltip ng-if="!enableEdit" class="tooltipcolor" md-direction="right">Edit disabled</md-tooltip>
